...
//  Map
//
//  Created by Jungwon on 2021/01/04.
//
...
class ViewController: UIViewController, CLLocationManagerDelegate {
    ...
    @IBOutlet var lb2LocationInfo2: UILabel!
    
    let locationManager = CLLocationManager()
    // CLLocationManager의 리턴값?
    
    override func viewDidLoad() {
        super.viewDidLoad()
        // Do any additional setup after loading the view.
        lb1LocationInfo1.text = ""
        lb2LocationInfo2.text = ""
    ...
    func locationManager(_ manager: CLLocationManager, didUpdateLocations locations: [CLLocation]) {
        ...
        CLGeocoder().reverseGeocodeLocation(pLocation!, completionHandler: {
            ...
            self.lb2LocationInfo2.text = address
            })
    ...
    @IBAction func sgChangeLocation(_ sender: UISegmentedControl) {
        if sender.selectedSegmentIndex == 0 {
            ...
            self.lb2LocationInfo2.text = "한국폴리텍대학 강릉캠퍼스"
            ...
            self.lb1LocationInfo1.text = "보고 계신 위치"
            self.lb2LocationInfo2.text = "이지스퍼블리싱 출판사 "
       }
    }
